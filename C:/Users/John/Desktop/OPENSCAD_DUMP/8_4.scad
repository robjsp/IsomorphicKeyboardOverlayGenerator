...
include<values.scad>
rotate([0,90,0])8_4();
module 8_4(keytops=false){
length=158.48425857813004;
rotate([0,-90,0]){
//Main Base:
difference(){
...
//Key Stalks:
translate([shift/4,(genh*4-(d+a)/2+overhead),baseHeight]){
linear_extrude(height=(keyTravelDistance*1.5+desiredGamut-4)){
...
if(keytops)
translate([0,(-0.5*(a+d)),(keyTravelDistance*1.5+desiredGamut-4+40)])
keytop();
}
translate([shift/4,(genh*16-(d+a)/2+overhead),baseHeight]){
linear_extrude(height=(keyTravelDistance*1.5+desiredGamut-16)){
scale((stalkScale+holeScale)/2,stalkScale)
polygon(points=[
[Points[0][0],Points[0][1]],[Points[1][0],Points[1][1]],[Points[2][0],Points[2][1]],[Points[3][0],Points[3][1]],[Points[4][0],Points[4][1]],[Points[5][0],Points[5][1]],[Points[6][0],Points[6][1]]
]);
...
if(keytops)
translate([0,(-0.5*(a+d)),(keyTravelDistance*1.5+desiredGamut-16+40)])
keytop();
}
//Feet:
...
cube([13.6,6.8,13.0],false);}}
translate([13.6,0.5,0])
rotate([0,27.613027823084472,0])
translate([0,0,-26.0])
cube([26.0,163.16666666666669,26.0]);
}
}}
