...
include<values.scad>
rotate([0,90,0])6_6();
module 6_6(keytops=false){
length=170.06759191146335;
rotate([0,-90,0]){
//Main Base:
difference(){
...
//Key Stalks:
translate([shift/4,(genh*6-(d+a)/2+overhead),baseHeight]){
linear_extrude(height=(keyTravelDistance*1.5+desiredGamut-6)){
...
if(keytops)
translate([0,(-0.5*(a+d)),(keyTravelDistance*1.5+desiredGamut-6+40)])
keytop();
}
translate([shift/4,(genh*18-(d+a)/2+overhead),baseHeight]){
linear_extrude(height=(keyTravelDistance*1.5+desiredGamut-18)){
scale((stalkScale+holeScale)/2,stalkScale)
polygon(points=[
[Points[0][0],Points[0][1]],[Points[1][0],Points[1][1]],[Points[2][0],Points[2][1]],[Points[3][0],Points[3][1]],[Points[4][0],Points[4][1]],[Points[5][0],Points[5][1]],[Points[6][0],Points[6][1]]
]);
...
if(keytops)
translate([0,(-0.5*(a+d)),(keyTravelDistance*1.5+desiredGamut-18+40)])
keytop();
}
}}
